...
import PropaneTankIcon from '@mui/icons-material/PropaneTank'; // ⭐ Nuevo
                    ...
                    {filteredSubmenu.map((subItem) => (
                      <ListItem key={subItem.path} disablePadding sx={{ pl: 2, mb: 0.5 }}>
                        <ListItemButton
                          ...
                          sx={{
                            borderRadius: 2,
                            bgcolor: isActive(subItem.path) ? '#4A90E2' : 'transparent',
                            '&:hover': {
                              bgcolor: isActive(subItem.path) ? '#5a9eeb' : 'rgba(255, 255, 255, 0.08)',
                            },
                          }}
                        >
                          <ListItemIcon sx={{ 
            ...
            <ListItem key={item.path} disablePadding sx={{ mb: 0.5 }}>
              <ListItemButton
                ...
                sx={{
                  ...
                  '&:hover': {
                    bgcolor: isActive(item.path) ? '#5a9eeb' : 'rgba(255, 255, 255, 0.08)',
                  },
                }}
              >
                <ListItemIcon sx={{ 
